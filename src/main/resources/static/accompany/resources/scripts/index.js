        ...
        if (xhr.readyState === XMLHttpRequest.DONE) {
            ...
            if (xhr.status >= 200 && xhr.status < 300) {
                ...
                for (let article of responseJson['accompanyArticles']) {
                    ...
                    const nickNameElement = window.document.createElement('span');
                    nickNameElement.classList.add('nickname');
                    nickNameElement.innerText = article['userNickname'];

                    accompanyElement.append(imgElement, locationContainerElement, titleContainerElement, contentElement, nickNameElement);
